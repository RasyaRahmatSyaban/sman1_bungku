<x-siswa-layout title="Nilai" section_title="Nilai Saya">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse ($nilaiList as $nilai)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $nilai->jadwal->mata_pelajaran->guru->nama }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{{ $nilai->jadwal->mata_pelajaran->nama_mapel ?? '-' }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $nilai->nilai }}</td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Belum ada nilai.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
