...
<div class="max-w-xl mx-auto mt-10 p-6 bg-white rounded shadow">
    ...
    <form method="POST" action="{{ route('siswa.profile.update') }}">
        ...
        <div class="mb-4">
            ...
            <textarea name="alamat" class="w-full border p-2 rounded">{{ old('alamat', $siswa->alamat) }}</textarea>
        ...
        <div class="mb-4">
            ...
            @error('jk') <p class="text-red-500 text-sm">{{ $message }}</p> @enderror
        </div>
        ...
        <a href="{{ route('siswa.profile.show') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 p-2">
            Kembali
        </a>
