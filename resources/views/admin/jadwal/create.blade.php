<x-admin-layout title="Jadwal" section_title="Tambahkan Jadwal Baru">
            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('admin.jadwal.store') }}" method="POST">
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <a href="{{ route('admin.jadwal.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 p-2 focus:ring-sky-500">
                            Batal
                        </a>
