<x-admin-layout title="Kelas" section_title="Edit Data Kelas">
            ...
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('admin.kelas.update', $kelas->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <select id="wali_kelas" name="wali_kelas" 
                                    ...
                                    <option value="{{ $wali->id }}" {{ old('wali_kelas', $wali->id_wali_kelas) == $wali->id ? 'selected' : '' }}>
                                        {{ $wali->nama }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <a href="{{ route('admin.kelas.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 p-2">
                            Batal
                        </a>
