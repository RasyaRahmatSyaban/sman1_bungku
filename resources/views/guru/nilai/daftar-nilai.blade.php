<x-guru-layout title="Nilai" section_title="Daftar Nilai - Guru">
    <!-- Notification -->
    @if (session('success'))
    ...
    <!-- Header Section -->
    <div class="mb-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-4">Pilih Kelas untuk Input Nilai</h2>
        <p class="text-sm text-gray-600 mb-6">Pilih jadwal kelas yang ingin Anda input nilainya.</p>
    </div>
        ...
        @empty
            <div class="col-span-full">
                <div class="text-center py-12">
                    <i class="ph ph-chart-bar text-gray-400 text-6xl mb-4"></i>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">Tidak Ada Jadwal</h3>
                    <p class="text-sm text-gray-500">Belum ada jadwal yang tersedia untuk input nilai.</p>
                </div>
            </div>
        @endforelse
    </div>
