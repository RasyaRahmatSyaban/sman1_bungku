        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-100">
            <div class="p-6">
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-xl font-semibold text-gray-800">{{ $user->guru->nama ?? $user->username ?? 'Teacher' }}</h2>
                ...
                @else
                    <div class="space-y-4">
                        ...
                        <div class="border-b border-gray-100 pb-4">
                            ...
                            <div class="text-gray-800">{{ $user->guru->alamat ?? 'Not available' }}</div>
                        </div>
                        @endif
                    </div>
                @endif
                ...
                <div class="mt-6 flex justify-end gap-2">
                    <a href="{{ route('guru.profile.edit', $user->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-150">
