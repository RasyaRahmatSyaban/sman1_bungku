...
<body class="bg-gray-50 min-h-screen flex flex-col">
    <header x-data="{ open: false, profileOpen: false }" class="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <i class="ph ph-chalkboard-teacher text-blue-600 text-2xl mr-2"></i>
                    ...
                    <nav class="hidden sm:ml-10 sm:flex sm:space-x-4">
                        <a href="{{ route('guru.dashboard') }}" 
                           class="{{ request()->is('guru/dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-chart-pie mr-1"></i>
                            Dashboard
                        </a>
                        <a href="{{ route('guru.jadwal.index') }}" 
                           class="{{ request()->is('guru/jadwal*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-calendar mr-1"></i>
                            Jadwal
                        </a>
                        <a href="{{ route('guru.kelas.index') }}" 
                           class="{{ request()->is('guru/kelas*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-chalkboard mr-1"></i>
                            Kelas
                        </a>
                        <a href="{{ route('guru.absensi.index') }}" 
                           class="{{ request()->is('guru/absensi*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-clipboard mr-1"></i>
                            Absensi
                        </a>
                        <a href="{{ route('guru.nilai.index') }}" 
                           class="{{ request()->is('guru/nilai*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                ...
                <div class="hidden sm:flex sm:items-center">
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                             ...
                             style="display: none;">
                            <div class="py-1">
                                <a href="{{ route('guru.profile.show') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
        ...
        <div x-show="open" class="sm:hidden border-t border-gray-200 bg-white" style="display: none;">
            ...
            <div class="pt-2 pb-3 space-y-1 px-4">
                <a href="{{ route('guru.profile.show') }}" class="hover:bg-gray-100 text-gray-600 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-150" @click="open = false">
