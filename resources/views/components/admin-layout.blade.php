                ...
                <div class="flex items-center">
                    ...
                    <nav class="hidden sm:ml-10 sm:flex sm:space-x-4">
                        <a href="{{ route('admin.dashboard') }}" 
                           class="{{ request()->is('dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-chart-pie mr-1"></i>
                            Dashboard
                        </a>
                        <a href="{{ route('admin.guru.index') }}" 
                           class="{{ request()->is('guru*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-chalkboard-teacher mr-1"></i>
                            Guru
                        </a>
                        <a href="{{ route('admin.kelas.index') }}" 
                           class="{{ request()->is('kelas*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-chalkboard mr-1"></i>
                            Kelas
                        </a>
                        <a href="{{ route('admin.siswa.index') }}" 
                           class="{{ request()->is('siswa*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-users mr-1"></i>
                            Siswa
                        </a>
                        <a href="{{ route('admin.mata-pelajaran.index') }}" 
                           class="{{ request()->is('mata-pelajaran*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-book-open mr-1"></i>
                            Mata Pelajaran
                        </a>
                        <a href="{{ route('admin.jadwal.index') }}" 
                           class="{{ request()->is('jadwal*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                            <i class="ph ph-calendar mr-1"></i>
                            Jadwal
                        </a>
                        <a href="{{ route('admin.absensi.index') }}" 
                           class="{{ request()->is('absensi*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                           px-3 py-2 rounded-md text-sm font-medium transition-colors duration-150">
                ...
                <div class="hidden sm:flex sm:items-center">
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                             ...
                             style="display: none;">
                            <div class="py-1">
                                <a href="{{ route('admin.profile.show') }}" class="group flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900">
        ...
        <div x-show="open" class="sm:hidden border-t border-gray-200 bg-white" style="display: none;">
            <div class="pt-2 pb-3 space-y-1 px-4">
                ...
                <a href="{{ route('admin.guru.index') }}" 
                   class="{{ request()->is('guru*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
                   block px-3 py-2 rounded-md text-base font-medium transition-colors duration-150" @click="open = false">
                    <i class="ph ph-chalkboard-teacher mr-2"></i>
                    Guru
                </a>
                <a href="{{ route('admin.kelas.index') }}" 
                   class="{{ request()->is('kelas*') ? 'bg-blue-50 text-blue-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }} 
            ...
            <div class="pt-2 pb-3 space-y-1 px-4">
                <a href="{{ route('admin.profile.show') }}" class="hover:bg-gray-100 text-gray-600 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium transition-colors duration-150" @click="open = false">
