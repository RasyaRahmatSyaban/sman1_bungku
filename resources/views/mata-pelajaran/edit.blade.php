<x-default-layout title="Mata Pelajaran" section_title="Edit Data Mata Pelajaran">
                ...
                <form action="{{ route('mata-pelajaran.update', $mapel->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" id="nama" name="nama_mapel" value="{{ old('nama', $mapel->nama_mapel) }}" 
                                ...
                                required>
                                    ...
                                    @foreach($gurus as $guru)
                                        <option value="{{ $guru->id }}"
                                            {{ old('id_guru', $mapel->guru->id) == $guru->id ? 'selected' : '' }}
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        <a href="{{ route('mata-pelajaran.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 p-2 focus:ring-sky-500">
                            Batal
                        </a>
